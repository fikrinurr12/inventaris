            ...
            <table class="table text-center table-striped table-bordered" id="tabel_laporan">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Baik</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Rusak</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel_laporan').DataTable({
            ...
            ajax: {
                url: "{{ route('laporan.pengembalian.data') }}",
                data: function(d) {
